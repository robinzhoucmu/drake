...
// See github.com/robinzhoucmu/Pushing/blob/master/differential_flat/PushActionDubins.m
// for a similar implementation in Matlab.. 

class DubinsPushPlanner {
 public:
  // Construct the class and set parameters for reduction.
  DubinsPushPlanner(Eigen::Vector2d contact_point, Eigen::Vector2d contact_normal, 
 ...
 private:
  ...
  void GetDubinsPathFlatOutput(const Eigen::Vector3d flat_agumented_z_start, 
